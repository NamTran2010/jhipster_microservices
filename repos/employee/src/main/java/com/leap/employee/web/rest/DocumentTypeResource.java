...
import com.leap.employee.repository.DocumentTypeRepository;
import com.leap.employee.service.DocumentTypeService;
...
/**
 * REST controller for managing {@link com.leap.employee.domain.DocumentType}.
 */
@RestController
@RequestMapping("/api")
public class DocumentTypeResource {
    ...
    private static final String ENTITY_NAME = "employeeDocumentType";
