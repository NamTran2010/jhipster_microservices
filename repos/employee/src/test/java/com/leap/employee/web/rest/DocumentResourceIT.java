...
class DocumentResourceIT {
    ...
    public static Document createEntity(EntityManager em) {
        Document document = new Document().documentName(DEFAULT_DOCUMENT_NAME).description(DEFAULT_DESCRIPTION);
        return document;
    }
    ...
    public static Document createUpdatedEntity(EntityManager em) {
        Document document = new Document().documentName(UPDATED_DOCUMENT_NAME).description(UPDATED_DESCRIPTION);
        return document;
    }
    ...
    void putNewDocument() throws Exception {
        ...
        updatedDocument.documentName(UPDATED_DOCUMENT_NAME).description(UPDATED_DESCRIPTION);
